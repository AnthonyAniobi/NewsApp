      ...
      body: SafeArea(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              InfoText(title: 'Id', message: poll.id.toString()),
              InfoText(title: 'Score', message: poll.score.toString()),
              InfoText(
                  title: 'Time',
                  message: DateFormat('dd MMMM yyyy').format(poll.exactTime)),
              RichText(
              ...
              if (poll.kids.isEmpty)
                ...
                GetX<PollController>(builder: (controller) {
                  return Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      ...
                      children: [
                        Text('Parts',
                            style: TextStyle(
                                ...
                                fontWeight: FontWeight.bold)),
                        SizedBox(height: 2.w),
                        ...controller.allParts.map((e) => e.toWidget()),
                        SizedBox(height: 2.w),
                        Center(
                          child: TextButton(
                              onPressed: () {
                                controller.loadPollMore(poll);
                              },
                              child: Text(
                                "Load More",
                                style: TextStyle(
                  ...
                  return Column(
                      ...
                      children: [
                        ...
                        Center(
                          child: TextButton(
                              onPressed: () {
                                controller.loadMoreComment(poll);
                              },
                              child: Text(
                                "Load More",
                                style: TextStyle(
